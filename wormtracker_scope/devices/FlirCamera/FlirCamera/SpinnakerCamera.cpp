...
void SpinnakerCamera::set_frame_rate_enable(std::string framerateenable)
{
	...
	try
	{
		...
		if (framerateenable == "Off")
		{
			ptrFrameRateEnable->SetValue(0);
		}
		else if (framerateenable == "On")
		{
			ptrFrameRateEnable->SetValue(1);
		}
	}
	catch (Spinnaker::Exception &e)
	{
